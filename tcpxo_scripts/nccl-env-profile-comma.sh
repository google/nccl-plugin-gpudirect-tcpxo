...
# NCCL_LIB_DIR="/usr/local/tcpxo/lib64" source scripts/nccl-env-profile-comma.sh
...
export NCCL_SHIMNET_GUEST_CONFIG_CHECKER_CONFIG_FILE=${NCCL_LIB_DIR}/a3plus_guest_config_comma.textproto
export NCCL_FASTRAK_PLUGIN_ACCEPT_TIMEOUT_MS=600000
export NCCL_DEBUG=WARN
export NCCL_DEBUG_SUBSYS=INIT,NET,ENV,COLL,GRAPH
export NCCL_NVLS_ENABLE=1
# Profiler on
export NCCL_PROFILER_PLUGIN=comma
export NCCL_TELEMETRY_MODE=4

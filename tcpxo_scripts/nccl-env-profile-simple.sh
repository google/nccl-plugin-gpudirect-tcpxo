...
#
# Set the recommanded environment variables for tcpo stack.
# User must set the ${NCCL_LIB_DIR} used
# inside the workload container.
# Sample usage before running workload:
# NCCL_LIB_DIR="/usr/local/tcpxo/lib64" source scripts/nccl-env-profile-simple.sh
...
export NCCL_TUNER_CONFIG_PATH=${NCCL_LIB_DIR}/a3plus_tuner_config_simple.textproto
export NCCL_SHIMNET_GUEST_CONFIG_CHECKER_CONFIG_FILE=${NCCL_LIB_DIR}/a3plus_guest_config_simple.textproto
